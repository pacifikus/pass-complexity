...
from pass_complexity.pipelines.data_processing.nodes import preprocess_passwords, fit_tokenizer, tokenize_data
...
def create_pipeline(**kwargs):
    return Pipeline(
        [
            ...
            node(
                func=tokenize_data,
                inputs=["tokenizer", "preprocessed_passwords", "preprocessed_test", "params:max_input_length"],
